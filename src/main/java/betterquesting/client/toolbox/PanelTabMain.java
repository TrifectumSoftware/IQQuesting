...
public class PanelTabMain extends CanvasEmpty {
    ...
    public void initPanel() {
        ...
        this.addPanel(
            new PanelButton(new GuiRectangle(0, 0, w / 2, 16, 0), -1, "" + ToolboxTabMain.INSTANCE.getSnapValue()) {
                ...
                .setTooltip(
                    makeToolTip(
                        QuestTranslation.translate("betterquesting.toolbox.tool.snap.name"),
        ...
        this.addPanel(new PanelButton(new GuiRectangle(w / 2, 0, w / 2, 16, 0), -1, "") {
            ...
            .setTooltip(
                makeToolTip(
                    QuestTranslation.translate("betterquesting.toolbox.tool.raw.name"),
        ...
        for (int i = 0; i < toolEntries.size(); i++) {
            ...
            int x = (i % 2) * (w / 2);
            int y = (i / 2) * 16 + 24;
            PanelButtonStorage<IToolboxTool> btn = new PanelButtonStorage<>(
                new GuiRectangle(x, y, w / 2, 16, 0),
                -1,
                "",
                entry.tool);
            btn.setActive(toolController.getActiveTool() != entry.tool);
            btn.setIcon(entry.tex)
                .setTooltip(entry.tt);
        ...
        this.addPanel(
            new PanelButton(
                new GuiRectangle(0, (toolEntries.size() / 2 + 1) * 16 + 24, w / 2, 16, 0),
                -1,
                "" + ToolboxTabMain.INSTANCE.getSnapValue()) {
    ...
    private static List<String> makeToolTip(String title, String desc) {
        ...
        list.add(title);
        list.addAll(
            Minecraft.getMinecraft().fontRenderer.listFormattedStringToWidth(EnumChatFormatting.GRAY + desc, 128));
        return list;
    }
    ...
    static {
        toolEntries.add(
            new ToolEntry(
                ...
                makeToolTip(
                    QuestTranslation.translate("betterquesting.toolbox.tool.open.name"),
        ...
        toolEntries.add(
            new ToolEntry(
                ...
                makeToolTip(
                    QuestTranslation.translate("betterquesting.toolbox.tool.new.name"),
        ...
        toolEntries.add(
            new ToolEntry(
                ...
                makeToolTip(
                    QuestTranslation.translate("betterquesting.toolbox.tool.grab.name"),
        ...
        toolEntries.add(
            new ToolEntry(
                ...
                makeToolTip(
                    QuestTranslation.translate("betterquesting.toolbox.tool.link.name"),
        ...
        toolEntries.add(
            new ToolEntry(
                ...
                makeToolTip(
                    QuestTranslation.translate("betterquesting.toolbox.tool.copy.name"),
                    QuestTranslation.translate("betterquesting.toolbox.tool.copy.desc"))));
        toolEntries.add(
            new ToolEntry(
                new ToolboxToolScale(),
                PresetIcon.ICON_SCALE.getTexture(),
                makeToolTip(
                    QuestTranslation.translate("betterquesting.toolbox.tool.scale.name"),
                    QuestTranslation.translate("betterquesting.toolbox.tool.scale.desc"))));
        toolEntries.add(
            new ToolEntry(
                new ToolboxToolDelete(),
                PresetIcon.ICON_TRASH.getTexture(),
                makeToolTip(
                    QuestTranslation.translate("betterquesting.toolbox.tool.delete.name"),
                    QuestTranslation.translate("betterquesting.toolbox.tool.delete.desc"))));
        toolEntries.add(
            new ToolEntry(
                new ToolboxToolRemove(),
                PresetIcon.ICON_NEGATIVE.getTexture(),
                makeToolTip(
                    QuestTranslation.translate("betterquesting.toolbox.tool.remove.name"),
                    QuestTranslation.translate("betterquesting.toolbox.tool.remove.desc"))));
        toolEntries.add(
            new ToolEntry(
                new ToolboxToolComplete(),
                PresetIcon.ICON_TICK.getTexture(),
                makeToolTip(
                    QuestTranslation.translate("betterquesting.toolbox.tool.complete.name"),
                    QuestTranslation.translate("betterquesting.toolbox.tool.complete.desc"))));
        toolEntries.add(
            new ToolEntry(
                new ToolboxToolReset(),
                PresetIcon.ICON_REFRESH.getTexture(),
                makeToolTip(
                    QuestTranslation.translate("betterquesting.toolbox.tool.reset.name"),
        ...
        toolEntries.add(
            new ToolEntry(
                ...
                makeToolTip(
                    QuestTranslation.translate("betterquesting.toolbox.tool.icon.name"),
                    QuestTranslation.translate("betterquesting.toolbox.tool.icon.desc"))));
        toolEntries.add(
            new ToolEntry(
                new ToolboxToolFrame(),
                PresetIcon.ICON_NOTICE.getTexture(),
                makeToolTip(
                    QuestTranslation.translate("betterquesting.toolbox.tool.frame.name"),
